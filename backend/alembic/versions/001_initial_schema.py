...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["debug_session_id"], ["debug_sessions.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["candidate_patch_id"], ["candidate_patches.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["debug_session_id"], ["debug_sessions.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "patch_success", sa.Boolean(), nullable=False, server_default="false"
        ),
        ...
        sa.Column(
            "daily_usage_count", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
