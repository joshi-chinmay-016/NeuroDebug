...
from database.models import User, SubscriptionPlan, SubscriptionTier
from repositories.subscription_repository import SubscriptionRepository
from repositories.usage_log_repository import UsageLogRepository
from services.usage_limit_service import UsageLimitService, UsageLimitExceededError
...
async def test_get_daily_limit():
    ...
    async with get_db_session() as session:
        ...
        enterprise_limit = await service.get_daily_limit(SubscriptionTier.ENTERPRISE.value)
