...
class TestProjectRepository:
    ...
    async def test_get_project_by_id(
        ...
        retrieved_project = await project_repository.get_project_by_id(
            created_project.id
        )
    ...
    async def test_get_projects_by_user(
        ...
        await project_repository.create_project(user_id=test_user.id, name="Project 1")
        await project_repository.create_project(user_id=test_user.id, name="Project 2")
        await project_repository.create_project(user_id=test_user.id, name="Project 3")

        projects = await project_repository.get_projects_by_user(test_user.id)
    ...
    async def test_update_project(
        ...
        project = await project_repository.create_project(
            user_id=test_user.id, name="Original Name"
        )
    ...
    async def test_delete_project(
        ...
        await project_repository.delete_project(project.id)

        # Project should still exist but with deleted_at set
        deleted_project = await project_repository.get_project_by_id(
    ...
    async def test_get_projects_excludes_archived(
        ...
        await project_repository.create_project(
            user_id=test_user.id, name="Active Project"
        )
        archived = await project_repository.create_project(
            user_id=test_user.id, name="Archived Project"
        )
